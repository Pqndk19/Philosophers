...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/12 14:02:35 by mmassa-r          #+#    #+#             */
/*   Updated: 2023/09/12 14:02:36 by mmassa-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_philo
{
	...
	pthread_mutex_t lock_live; 			/*lock for other things*/
	struct s_data *data;
}	t_philo;
...
typedef struct s_data
{
	...
	t_philo *all_philos;				/*"string" of threads(philos)*/
	pthread_mutex_t	lock_print; 		/*lock for printf*/
	pthread_mutex_t lock_verify; 		/*lock for verify if philosopher is dead and if everyone ate*/
	pthread_mutex_t *forks;
	pthread_t supervise; 				/*checks if some philospher died or everyone ate*/
}	t_data;
